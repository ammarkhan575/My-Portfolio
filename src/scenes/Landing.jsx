            ...
            <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32">
                {isAboveMediumScreens ? (
                    <div className="relative z-0 ml-20 before:absolute  before:rounded-t-[400px] before:w-full before:max-w-[400px] before:h-full before:border-2 before:border-blue before:z-[-1]">
                        <img src={pf} alt="profile" className="hover:filter hover:saturate-200 transition animate-lightBounce duration-500 z-10 w-full max-w-[400px]" />
                    </div>

                ) : (
                    <img src={pf} alt="profile" className="hover:filter hover:saturate-200 animate-lightBounce transition duration-500 z-10 w-full max-w-[400px] md:max-w-[600px]" />
                )}
            </div>
